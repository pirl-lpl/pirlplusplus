...
PIRL CVS ID: $Id: Files_test.cc,v 1.11 2010/11/21 20:36:47 castalia Exp $

Copyright (C) 2006-2010  Arizona Board of Regents on behalf of the Planetary
...
if (test_file)
	...
	try
		...
		{
		cout << "!!! Exception from file_is_readable ("
				<< test_filename << ")" << endl
			 << except.what () << endl;
		}
	...
	try
		...
		{
		cout << "!!! Exception from file_is_writeable ("
				<< test_filename << ")" << endl
			 << except.what () << endl;
		}
...
if (! CreateDirectory (test_directory.c_str (), NULL))
	cout << "!!! Unable to create a test directory - \""
		<< test_directory << '"' << endl;
#else
